...
<div class="report-container">
    <h1>KI-Auditsimulation: Phase 
        "<span class='highlight-marker'>{Phasen.ORGANIZING.value}</span>"
    </h1>
...
async def main():
    ...
    if "organizing_new_user_input" not in st.session_state:
        st.session_state.organizing_new_user_input = False
    ...
    if user_input:
        ...
        st.session_state.organizing_new_user_input = True
        ...
        with st.chat_message("assistant"):
            ...
            if st.session_state.organizing_chat_state == ChatState.GET_CONTEXT_INFO:
