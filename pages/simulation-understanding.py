...
from ui.html import get_new_review_text, get_default_hint_text, get_padding_html, get_header_html, \
    get_tertiary_button_html, get_menu_heading_html, get_review_html, get_sidebar_html, get_final_review_html
...
async def run_agent_with_streaming(user_input, use_history=True, add_message=True):
    ...
    async with chat_agent.run_stream(
        ...
        message_history=st.session_state.und_chat_messages if use_history else None
    ) as result:
